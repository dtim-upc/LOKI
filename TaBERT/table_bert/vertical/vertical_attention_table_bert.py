    ...
    def __init__(
        ...
        **kwargs
        ...
        if config.initialize_from:
            ...
            initial_state_dict = torch.load(config.initialize_from, map_location='cpu', weights_only=False)
    ...
    def forward(
        ...
        **kwargs
        ...
        if TRANSFORMER_VERSION == TransformerVersion.PYTORCH_PRETRAINED_BERT:
            bert_kwargs = {'output_all_encoded_layers': False}
        else:
            bert_kwargs = {}
